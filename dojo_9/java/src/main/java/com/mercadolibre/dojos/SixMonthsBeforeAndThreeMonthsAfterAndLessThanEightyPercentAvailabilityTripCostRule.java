 ...
 */
public class SixMonthsBeforeAndThreeMonthsAfterAndLessThanEightyPercentAvailabilityTripCostRule extends TripCostRule{

    private ApiAvailabilityService apiAvailabilityService;

    SixMonthsBeforeAndThreeMonthsAfterAndLessThanEightyPercentAvailabilityTripCostRule(ApiAvailabilityService apiAvailabilityService){
